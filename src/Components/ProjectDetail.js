...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    ...
    // Format images for ImageGallery component if they exist
    if (foundProject && foundProject.images && foundProject.images.length > 0) {
      const formattedImages = foundProject.images.map(imagePath => ({
        original: imagePath,
        thumbnail: imagePath,
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="mt-4 mb-5 text-center">
              <Link to="/" className="btn btn-secondary" style={{ color: "#ffffff" }}>
